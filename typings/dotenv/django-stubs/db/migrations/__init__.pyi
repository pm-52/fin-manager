...
class ModelState:
    ...
    def __init__(self, app_label: str, name: str, fields: List[Tuple[str, Field[Any, Any]]], options: Optional[Dict[str, Any]] = ..., bases: Optional[Sequence[Union[Type[Model], str]]] = ..., managers: Optional[List[Tuple[str, Manager[Any]]]] = ...) -> None:
        ...
