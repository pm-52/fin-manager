...
def make_immutable_fields_list(name: str, data: Union[Iterator[Any], List[Union[ArrayField[Any], CIText]], List[Union[Field[Any, Any], FieldCacheMixin]]],) -> ImmutableList[Any]:
    ...
...
class Options(Generic[_M]):
    ...
    def get_ancestor_link(self, ancestor: Type[Model]) -> Optional[OneToOneField[Any]]:
        ...
    ...
    def get_fields(self, include_parents: bool = ..., include_hidden: bool = ...) -> List[Union[Field[Any, Any], ForeignObjectRel]]:
        ...
