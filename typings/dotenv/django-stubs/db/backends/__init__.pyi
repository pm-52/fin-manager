...
class Columns(TableColumns):
    ...
    def __init__(self, table: str, columns: List[str], quote_name: Callable[..., Any], col_suffixes: Union[List[str], Tuple[Any, ...]] = ...) -> None:
        ...
...
class ForeignKeyName(TableColumns):
    ...
    def __init__(self, from_table: str, from_columns: List[str], to_table: str, to_columns: List[str], suffix_template: str, create_fk_name: Callable[..., Any]) -> None:
        ...
