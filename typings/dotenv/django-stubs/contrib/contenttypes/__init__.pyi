...
class GenericForeignKey(FieldCacheMixin):
    ...
    def get_prefetch_queryset(self, instances: Union[List[Model], QuerySet[Any]], queryset: Optional[QuerySet[Any]] = ...) -> Tuple[List[Model], Callable[..., Any], Callable[..., Any], bool, str, bool]:
        ...
