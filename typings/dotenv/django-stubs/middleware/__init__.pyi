...
class CsrfViewMiddleware(MiddlewareMixin):
    ...
    def process_view(self, request: HttpRequest, callback: Optional[Callable[..., Any]], callback_args: Tuple[Any, ...], callback_kwargs: Dict[str, Any]) -> Optional[HttpResponseForbidden]:
        ...
